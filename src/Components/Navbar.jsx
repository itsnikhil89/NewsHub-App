...
const Navbar = ({setCategory}) => {
  return (
    ...
    <div className="container-fluid">
      <a className="navbar-brand" href="#"><span className="badge bg-success text-light fs-4">NewsHub</span></a>
      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav">
          <li className="nav-item">
            <div className="nav-link text-light" style={{cursor:"pointer"}} onClick={()=>setCategory("technology")}>Tehnology</div>
          </li>
          <li className="nav-item">
